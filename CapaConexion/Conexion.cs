...
namespace CapaConexion
{
    public class Conexion
    {
        ...
        {
            SqlConnection con;
            using (con = new SqlConnection(sConnectionString))
            {
                try
                {
                    con.Open();
                ...
                catch (Exception)
                {
                    ...
                    MessageBox.Show("Error en la conexión con la BD", "mensaje Sistema");
                    return;
                }
            }
        }
        ...
        public void conectar()
        {
           ...
           public static void Main(String[] args)
           {
            ...
            conec1.CadenaConexion = "Server=127.0.0.1;Database=IMC;Trusted_Connection=True;";
